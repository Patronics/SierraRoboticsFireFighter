...
loop while gobutton=0
	...
	sertxd("Starting Program!",cr,lf,cr,lf)
...
if w5<10 and timer>3 then             'backup if too close to wall
	gosub gobackward
'hpwmDuty 1023
elseif Rusrfval > 165 and Lusrfval > 165 then         
...
printpower:
	...
	returnb4 = returnb3 // 10		; Hundredths digit
	returnb3 = returnb3 / 10		; Tenths digit
	sertxd("Vdd= ",#returnw2,".",#returnb3,#returnb4," Volts ")
	return