...
if Lusrfval < 50 and Fusrfval < 20 then
	gosub turnright
else
	'goto main
	
	endif
if Lusrfval < 35 and Rusrfval < 100 and timer < 3 then 
	gosub turnright 
	pause 200
	gosub goforward
	pause 1000
...
if Fusrfval < 50 and Rusrfval < 50 and timer<3 then
	gosub turnleft
else
	'goto main
endif	
if Lusrfval < 50 and Rusrfval < 50 then
	gosub goforward
else
endif
	'goto main
if Fusrfval > 100 and Rusrfval > 100 then
	gosub turnright
endif
if Lusrfval > 100 and Rusrfval >100 then
	gosub turnright	
...
if ldr1on=1 and timer>3 then     ''''''   now old: CHANGE BACK TO 4, 200 ONLY FOR TESTING!!
